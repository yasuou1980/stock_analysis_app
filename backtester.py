...
def calculate_indicators_and_signals(data_hash, _data, params, strategy_type="トレンドフォロー"):
    ...
    try:
        ...
        if strategy_type == "トレンドフォロー":
            ...
            sell_signal = (scores <= sell_threshold_adj) & structure_broken
            ...
            # 最終シグナル判定
            buy_signal_c = oversold_recent & long_trend_ok & ~falling_knife & rebound_confirm
            ...
            sell_final_c = (sell_signal_c | early_sell_signal_c) & ~strong_uptrend_block
            ...
            trend_sell_r = (trend_sc_r <= sthr_r) & structure_broken_r & mtf_sell_r
            ...
            osr_cr = (pd.Series(counter_sc_r, index=data.index)
                      .rolling(window=3, min_periods=1).max() >= 5.0)
            counter_buy_r  = osr_cr & lt_ok_cr & ~knife_cr & rebound_cr
            ...
            counter_sell_all_r = (counter_sell_r | early_sell_cr) & ~strong_up_block_r
